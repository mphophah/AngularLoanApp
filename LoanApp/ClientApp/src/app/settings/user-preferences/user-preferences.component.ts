...
export class UserPreferencesComponent {
  ...
  homePages: PageInfo[] = [
    ...
    { title: 'Potential Clients', icon: 'contacts', path: '/customers', isDefault: false },
    { title: 'Indivitual Plicy', icon: 'person', path: '/principalMember', isDefault: false },
    { title: 'Group Policy', icon: 'people', path: '/groupCover', isDefault: false },
